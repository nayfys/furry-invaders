class Game {
  constructor() {
    ...
    this.covers = [];
    this.invaderDir = 1;
    this.invaderSpeed = 10; // pixels per step
    this.invaderMoveInterval = 30; // frames
    this.invaderShootInterval = 60; // frames between invader bomb attempts
    this.moveCounter = 0;
    this.score = 0;
    this.over = false;
    this.spawnInvaders();
  ...
  update() {
    ...
    if (!this.invaders.some(inv => inv.alive)) this.over = true;
  }
